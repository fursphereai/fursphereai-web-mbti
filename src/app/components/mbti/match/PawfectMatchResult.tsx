...
interface PawfectMatchResultProps {
  handleNext: () => void; 
  surveyData: SurveyData;
  updateAnswer: (category: keyof SurveyData, subCategory:any  | null, field: string, value: string) => void;
}

const PawfectMatchResult: React.FC<PawfectMatchResultProps>  = ({ handleNext,step, setStep,  surveyData, updateAnswer  }) => {
  ...
  return (
    <div className="p-4 bg-gray-200 rounded-lg shadow-lg max-w-md mx-auto">
      <div className="bg-blue-600 text-white text-xl font-bold p-3 rounded-t-lg text-center">
       Pawfect Match Result
      </div>
      <div className="bg-gray-100 p-6 rounded-b-lg text-center">
       <div className=" text-black text-[50px] font-bold p-3 rounded-t-lg text-center">
       Pawfect Match Result
      </div>
        <button 
...
export default PawfectMatchResult;
