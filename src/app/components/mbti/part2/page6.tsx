...
const Page6: React.FC<BasicInfoScreenProps>  = ({ handleNext, handleBack, step, setStep, surveyData, updateAnswer  }) => {
  
  return (
    <div className=" bg-[#F5F5F5] h-screen ">
      
      <div className="flex flex-col  mx-auto max-w-[1440px] max-h-[720px] items-center justify-center h-full ">
        <label className="
                  mt-[40px]
                  text-[14px]
                  text-[#C3C3C3]
