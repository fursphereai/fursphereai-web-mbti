...
const Page16: React.FC<Page16Props> = ({
  handleNext,
  handleBack,
  handleSkip,
  surveyData,
  ...
  const [selectedOption, setSelectedOption] = useState<string>(
    surveyData.personality_and_behavior.Decision_Making.react_new_friend || '5'
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Decision_Making', 'react_new_friend', option);
  };
    ...
    <div className="quiz-container">
      ...
      <div className="slider-container desktop" style={{ display: isMobile ? 'none' : 'block' }}>
        ...
        <div className="label-row">
          <span className="option-label">☺️Obedience</span>
          <span className="option-label">👻Rebelliousness</span>
        </div>
      </div>
