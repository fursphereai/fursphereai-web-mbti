...
const Page13: React.FC<Page13Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<string>(
    surveyData.personality_and_behavior.Structure_Spontaneity.respond_to_scold || '5'
  );
    ...
    <div className="quiz-container">
      ...
      <div className="slider-container desktop" style={{ display: isMobile ? 'none' : 'block' }}>
        ...
        <div className="label-row">
          <span className="option-label">😆Exciting</span>
          <span className="option-label">‍🫥Avoidant</span>
        </div>
      </div>
