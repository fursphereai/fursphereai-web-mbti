...
const Page13: React.FC<Page13Props> = ({
  handleNext,
  handleBack,
  handleSkip,
  surveyData,
  ...
  const [selectedOption, setSelectedOption] = useState<string>(
    surveyData.personality_and_behavior.Structure_Spontaneity.respond_to_scold || '5' // 默认选5
  );

  const handleSelectOption = (option: string) => {
    setSelectedOption(option);
    updateAnswer('personality_and_behavior', 'Structure_Spontaneity', 'respond_to_scold', option);
  };
  ...
  return (
    <div className="quiz-container">
      ...
      <div className="question-container">
        <h2>How does your pet respond to scolding?</h2>
      </div>
      ...
      <div className="slider-container">
        ...
        <div className="label-row">
          <span className="option-label">😠 Defiant</span>
          <span className="option-label">😞 Submissive</span>
        </div>
      </div>
